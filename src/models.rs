...
pub struct AccountSummary {
    ...
    pub api_cost_lower_nano_usd: i64,
    pub api_cost_upper_nano_usd: i64,
    pub api_cost_complete_request_count: i64,
    pub api_cost_partial_request_count: i64,
    pub api_cost_unpriced_request_count: i64,
...
pub struct RequestLog {
    ...
    pub api_pricing_version: Option<String>,
    pub api_cost_status: Option<String>,
